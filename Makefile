...
##  $Header: /user_data/systems/yaya/cif/shar/xcshar/Makefile,v 1.1 1995/09/03 02:34:27 yaya Exp yaya $
##
...
#CFLAGS	= -g -O -D_NO_PROTO -DJUST_TEXT
#  Flags to build for non-AIX systems
CFLAGS  = -g -O -DJUST_TEXT
...
PROGRAMS= findsrc    makekit    shar    unshar    shell    cshar
MANPAGES= findsrc.$1 makekit.$1 shar.$1 unshar.$1 shell.$1 cshar.$1
...
cshar:		cshar.o $(HDRS) $(LIB)
	@rm -f $@
	$(CC) $(CFLAGS) -o cshar cshar.o $(LIB) $(DIRLIB)
