...
#ifdef	RCSID
static char RCS[] =
	"$Header: /Users/yaya/ccshar/RCS/findsrc.c,v 1.1 2005/08/03 02:31:07 root Exp root $";
#endif	/* RCSID */
...
static char	Dname[22];				/* Filename of directory list	*/
static char	Fname[22];				/* Filename of file list	*/
    ...
    REGISTER char	*av[];
{
    ...
    SetSigs(TRUE, Catch);
	strcpy(Dname,"/tmp/findDXXXXXX");
	strcpy(Fname,"/tmp/findFXXXXXX");
    mkstemp(Dname);
    mkstemp(Fname);
    Dfile = fopen(Dname, "w");
    Ffile = fopen(Fname, "w");
